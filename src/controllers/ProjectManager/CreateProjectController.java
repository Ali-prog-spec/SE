...
public class CreateProjectController {
  ...
  private void saveProject() {
    ...
    try (Connection conn = DatabaseConnection.getConnection()) {
        ...
        // Send notification (use separate DAO connection inside method)
        if (cmbFinanceOfficer.getValue() != null) {
            int financeOfficerId = cmbFinanceOfficer.getValue().getUserId();
            String msg = "New Project created: " + name + " (Status: On Track)";
            finNotificationDAO.sendNotificationToUser(financeOfficerId, msg);
        }
