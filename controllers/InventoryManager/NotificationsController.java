...
private void showNotifications(javafx.event.ActionEvent event) {
    try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/screens/InventoryManager/notifications.fxml"));
    ...
    private void goBack() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/screens/InventoryManager/Dashboard.fxml"));
            Parent root = loader.load();
