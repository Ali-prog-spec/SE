...
private void showNotifications(javafx.event.ActionEvent event) {
    try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/screens/ProcurementOfficer/notifications.fxml"));
    ...
    private void goBack() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/screens/ProcurementOfficer/Dashboard.fxml"));
            Parent root = loader.load();
